        ...
        <section className="flex-1 text-right self-center tablet:text-center">
          <div className="max-w-[573.9px] mobile:max-w-[321px] midiDesktop:text-white">
            <h1 className="text-64px mobile:text-36px font-bold mb-16px mobile:leading-36px leading-64px text-blue mb-16px">
              Click Next
              <span className="block highlight-text">below </span>
              to continue
            </h1>
            ...
            <Link to="/events">
              <button className="tablet:hidden hightligted-btn px-69hpx py-16px text-white text-16px font-bold tablet:absolute">
                <FaArrowRight className="inline-block" /> Next
              </button>
            </Link>
          </div>
        </section>
        <section className="order-first tablet:order-none flex-1">
          <form className="p-20px bg-[#F6F2FF] m-auto max-w-[311px]">
            ...
            <label className="block mb-10px">
              Event Name:
              <input className="rounded block w-full p-10px mt-5px" ref={eventNameRef} />
            </label>
            <label className="block mb-10px">
              Host Name:
              <input className="rounded block w-full p-10px mt-5px" ref={hostNameRef} />
            </label>
            <label className="block mb-10px">
              Start Date:
              <input type="datetime-local" className="rounded block w-full p-10px mt-5px" ref={startDateRef} />
            </label>
            <label className="block mb-10px">
              End Date:
              <input type="datetime-local" className="rounded block w-full p-10px mt-5px" ref={endDateRef} />
            </label>
          </form>
          <Link to="/events">
